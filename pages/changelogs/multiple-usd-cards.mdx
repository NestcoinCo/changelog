...
export const meta = {
  slug: "multiple-usd-cards",
  publishedAt: "2024-06-07T09:25:32.807Z",
  title: "Say Hello to Multiple USD Cards",
  headerImage: "https://i.ibb.co/WDgBZrv/chanagelog-banners-03.png",
...
Hey boarders! You can now create up to three USD cards and fund them with stablecoins from more networks including Base, Ethereum, and Polygon.

Plus, we’ve added a new inbox feature to keep you updated on all transactional activities!
