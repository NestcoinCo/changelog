...
function variantLandingOutline(props) {
  ...
  return {
    ...
    borderColor,
    _hover: {
      bg: mode(`purple.100`, `whiteAlpha.200`)(props),
    },
    _active: {
      bg: mode(`purple.100`, `whiteAlpha.200`)(props),
    },
...
function variantLandingSolid(props) {
  ...
  return {
    bg: mode(`${primary}.500`, `whiteAlpha.900`)(props),
    border: "1px solid",
...
function variantLandingGradient(props) {
  return {
    bgGradient: mode(`linear(to-b, purple.500, #4C40D9)`, `whiteAlpha.900`)(props),
    color: `white`,
    _hover: {
      bgGradient: `linear(to-b, #4C40D9, purple.800)`,
      _disabled: {
        bg: mode(`purple.300`, `whiteAlpha.900`)(props),
      },
    },
    _active: {
      bg: `purple.700`,
...
function variantLandingBtnOnboard(props) {
  return {
    bgGradient: mode(`linear(to-b, onboardblue.500, #4C40D9)`, `whiteAlpha.900`)(props),
    color: `white`,
    _hover: {
...
const variants = {
  ...
  landingGradient: variantLandingGradient,
  btnOnboard: variantLandingBtnOnboard
};
